      ...
      <main className="flex-1">
        <div className="container py-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-semibold mb-4">Competition Entry Portal</h2>

            <p className="text-lg mb-6">
              Enter Bowls New Zealand competitions through our official competition management system.
            </p>
            ...
            <Button className="bg-green-600 hover:bg-green-700 flex items-center gap-2" asChild>
              ...
              >
                Go to Competition Entry Portal <ExternalLink className="h-4 w-4" />
              </a>
            </Button>
          </div>

          <div className="prose max-w-none">
            <h3 className="text-xl font-semibold mb-3">How to Enter Competitions</h3>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3">Don't Have an Account?</h3>

            <p>
              You'll need a BowlsHub account to enter competitions. If you don't have one yet, you can register through
            ...
            <p>
              If you need help with entering a competition or have questions about the process, please contact our
              support team at{" "}
              <a href="mailto:support@bowlsnz.co.nz" className="text-green-600 hover:text-green-700">
