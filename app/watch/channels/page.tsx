    ...
    <div className="flex min-h-screen flex-col">
      ...
      <section className="relative bg-forest py-16 text-white">
        <div className="container">
          <h1 className="text-subsection text-center mb-8">
            BOWLS TV CHANNELS
          </h1>
          <p className="text-lead text-center max-w-4xl mx-auto">
            Bowls New Zealand's Bowls TV offers a variety of channels covering
            national and international lawn bowls events, as well as coaching
            content and tutorials. Explore our YouTube content below.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <h2 className="text-subsection text-forest text-center mb-8">
            FEATURED VIDEO
          </h2>
        ...
        <div className="container">
          <div className="flex flex-col items-center text-center">
            <p className="text-lead text-forest-light max-w-3xl mb-6">
              ...
              including coverage of the Summerset Nationals and international
              events.
            </p>
            <Button
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {channels.map((channel, index) => (
              <Card
                key={index}
                className="bg-white shadow-md overflow-hidden h-full hover:shadow-lg transition-shadow"
              >
                <CardContent className="p-0 h-full flex flex-col">
                    ...
                    {activeVideo === channel.videoId ? (
                      <div className="aspect-video w-full h-auto">
                        <iframe
                          ...
                          height="100%"
                          src={
                            channel.name === '"Beyond the Bias" Podcast Series'
                          ...
                          referrerPolicy={
                            channel.name ===
                              '"Beyond the Bias" Podcast Series' ||
                            channel.name === "International" ||
                            channel.name === "Twilight Bowls League" ||
                            channel.name === "Intercentre" ||
                            channel.name === "Bowls5" ||
                  ...
                  <div className="p-6 flex-grow flex flex-col">
                    <p className="text-body text-forest-light mb-3">
                      {channel.description}
                    </p>
                    <p className="text-caption font-semibold text-forest mb-6">
